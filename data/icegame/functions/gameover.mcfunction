...
execute as @a[x=0,gamemode=spectator] run title @a[x=0] title [{"selector": "@a[y=55,dy=100,gamemode=survival]"},{"text": " Wins!"}]
gamemode spectator @a[y=55,dy=100,gamemode=survival]
